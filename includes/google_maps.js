...
function load(lat,lng,xml_url) {
      ...
      smallgroup[id]='<img src="https://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|' + pinColor +'"/> '+markers[i].getAttribute("smallgroup_name") + ': ' + details +'<br/>';
