...
function church_admin_edit_facility($facilities_id=NULL)
{
        ...
        if(!empty($facilities_id))
	{
        ...
        echo'/></p>';
        echo'<p class="submit"><input type="hidden" name="edit_facility" value="yes"/><input  class="button-primary"  type="submit" value="'.__('Save Facility','church-admin').' &raquo;" /></p></form></div>';
